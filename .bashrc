...
# Shortcut to print clipboard content
alias echov='echo `xclip -o`'

# Shortcut to copy path
alias pwdc='pwd | xclip'

# Shortcut to access clipboard content
alias cdv='cd `xclip -o`'

# Shortcut to access my work's folder
alias cdw='cd ~/Documents/Behint/'
# Web tool
alias cdww='cd ~/Documents/Behint/web.view.ui/'
# Legacy Web tool
alias cdwwl='cd ~/Documents/Behint/webtool/'
# Api tool
alias cdwa='cd ~/Documents/Behint/apitool/'
# Academic
alias cda='cd ~/Documents/Academic/'

# Open vim
# Web tool
alias vimww='cdww && cd src && vim .'
# Legacy Web tool
alias vimwwl='cdwwl && cd src && vim .'
# Api tool
alias vimwa='cdwa && cd src && vim .'

# Shortcut to access my projects folder
